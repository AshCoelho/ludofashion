<?php
// Definimos a classe Usuario que vai representar um usuário no sistema.
class Usuario {
    ...
    public function create() {
        ...
        $query = 'INSERT INTO ' . $this->table_name . ' SET nome=:nome, email=:email, senha=:senha, cpf=:cpf, telefone=:telefone, nascimento=:nascimento';
        // Preparamos a query.
